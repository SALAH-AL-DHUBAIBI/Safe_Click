...
class ResultScreen extends StatelessWidget {
      ...
      children: [
        Expanded(
          child: ElevatedButton.icon(
            onPressed: () => _navigateToPage(context), // تغيير هنا: استدعاء دالة التنقل بدلاً من فتح الرابط
  ...
  // دالة جديدة للتنقل إلى الصفحة المطلوبة
  // دالة جديدة للتنقل إلى الصفحة المطلوبة
Future<void> _navigateToPage(BuildContext context) async {
  // تنسيق الرابط إذا كان بدون بروتوكول
